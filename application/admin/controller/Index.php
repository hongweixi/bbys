...
class Index extends Admin
{
    ...
    {
        $data = [
            'website'   => '<a target="_blank" href="http://www.szhycc.org.cn/">http://www.szhycc.org.cn/</a>',
            'community' => '<a target="_blank" href="http://www.szhycc.org.cn/">http://www.szhycc.org.cn/</a>',
            'version'   => 'v1.1',
            'devoloper' => '<a target="_blank" href="http://www.szhycc.org.cn/">深圳市衡阳商会</a>',
        ];
    ...
    {
        $data = [
            'document_count' => Db::name('posts')->where('post_type', 1)->where('post_status','<>',3)->count(),
